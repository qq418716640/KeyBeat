...
分数越低代表打字越密集（`score = 100 - 活跃度`）：

| 分数 | 状态 | 颜色 | 含义 |
|------|------|------|------|
| 0-19 | Deep Focus | 灰色 | 高强度打字，深度专注中 |
| 20-39 | Busy | 绿色 | 活跃使用键盘 |
| 40-59 | Moderate | 黄色 | 一般活跃 |
| 60-79 | Light | 橙色 | 偶尔打字 |
| 80-100 | Free | 红色 | 空闲，可以聊天 |
...
KeyBeat 的身份（UID）与浏览器绑定。如果你需要卸载重装扩展，可以提前备份身份以保留配对关系。

**备份：**
1. 点击 KeyBeat 图标 → **Backup Identity**
2. 点击生成的恢复码复制到剪贴板，妥善保存

**恢复：**
1. 重装扩展后，点击 KeyBeat 图标 → **Restore from backup**
2. 粘贴恢复码 → **Restore**
3. 身份和配对关系自动恢复
